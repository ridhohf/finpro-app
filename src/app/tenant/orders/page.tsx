...
function TenantOrdersPage() {
  ...
  const getPendingConfirmationCount = () => {
    return transactions.filter((t) => t.status === 'PENDING_CONFIRMATION')
      .length;
  };
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Kelola dan konfirmasi pesanan dari customer Anda
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative">
              ...
              <Input
                placeholder="Cari nama tamu, properti, atau booking ID..."
                value={searchQuery}
...
export default withAuth(TenantOrdersPage, {
  requireAuth: true,
  requiredRole: 'tenant',
